<template>
    <i
        ...
        :width="width"
        :height="height"
        class="svg svg-icon svg-content"
        :style="{
            '--svg-width': `${width}px`,
...
const props = defineProps({
  ...
  rect: { type: String, default: 'none' },
  width: { type: [Number, String], default: 'none' },
  height: { type: [Number, String], default: 'none' },
  additionalFolder: { type: String, default: '' }
})
